...
function send_mail(mail, sbj, msg) {
  ...
  smtp.sendMail(mailOptions, (err, res) => {
    if (err) {
      //console.log("smtp.sendMail Error:", err);
      return ("error");
    } else {
      return ("sent");
    }
  ...
  if (Object.keys(errors).length != 0)
    ...
    try {
      Users.createUser(new_user, function (err, users) {
        ...
        var sbj = "Tinder42 | Confirm Your E-mail";
        var msg = "Please click link below to verify your E-mail:</br><a href=\"" + link + "\">Click Here</a>";
...
exports.reset = (req, res) => {
  ...
  if (!String(email).match(/^[\-0-9a-zA-Z\.\+_]+@[\-0-9a-zA-Z\.\+_]+\.[a-zA-Z]{2,}$/) || email.length > 50) {
    ...
    var link = "http://localhost:8081/reset?t=" + token + "&e=" + email;
    var sbj = "Tinder42 | Reset your password";
    var msg = "</br><a href=\"" + link + "\">Click Here</a> To Rest your password";
    try{
