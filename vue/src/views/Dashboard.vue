            ...
            <div class="photo-box">
              <carousel :perPage="1" :paginationEnabled="true" :paginationPadding="5">
                <slide v-for="(img, j) in OneUser.Images" :key="j">
                  <div class="NOPE" v-if="displayNope"><img id="NOPE" src="../assets/nope.png"></div>
                  <div class="LIKE" v-if="displayLike"><img id="LIKE" src="../assets/like.png"></div>
                  <div class="MATCH" v-if="displayMatch"><img id="heart" src="../assets/likey.png"></div>
